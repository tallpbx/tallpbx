...
- **Load Tier Notation (`<Total Requests> x <Concurrency>`)**:
  - `25 x 1`: 25 total requests sent sequentially one at a time (concurrency 1).
  - `100 x 5`: 100 total requests distributed across 5 concurrent workers (20 requests per worker).
  - `500 x 10`: 500 total requests distributed across 10 concurrent workers (50 requests per worker).
  - `500 x 25`: 500 total requests distributed across 25 concurrent workers (20 requests per worker).
  - `1,000 x 25`: 1,000 total requests distributed across 25 concurrent workers (40 requests per worker; sustained burst ceiling).
