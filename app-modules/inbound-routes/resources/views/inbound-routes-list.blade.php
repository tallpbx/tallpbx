<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('panel.inbound-routes.create') }}" class="btn btn-primary btn-sm">
            <x-heroicon-o-plus class="w-4 h-4" />
            {{ __('admin.create_inbound_route') }}
        </a>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex gap-2">
                                    <a href="{{ route('panel.inbound-routes.edit', $route) }}" class="btn btn-ghost btn-xs">
    ...
    @if ($pendingDeletionId !== null)
        <x-confirmation-modal :open="true" :title="__('admin.modal_delete_inbound_route_title')" :message="__('admin.modal_delete_generic_question', ['name' => $pendingDeletionName])" :confirm-label="__('admin.modal_delete_inbound_route_confirm')" confirm-action="deleteRoute('{{ $pendingDeletionId }}')" cancel-action="cancelRouteDeletion" />
    @endif
</div>
